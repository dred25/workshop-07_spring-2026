...
# base layer: ggplot
ggplot(data = sonadora_sum, #data from sonadora summary
       aes(x = elevation_m, #x-axis elevation in meters
           y = mean_temp_c)) + # y-axis mean temp in degrees celsius  
...
# diagnostics
par(mfrow = c(2, 2)) #displays data in a 2x2 table
plot(temperature_model) #displays diagnostic plot of temperature model
